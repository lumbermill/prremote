# XIAO ESP32C6 — UDPSocket sample
# Connects to WiFi, then sends comma-separated numeric datagrams to a UDP server
# and prints each reply. Exercises the esp32c6 socket layer end to end:
# UDPSocket.new, connect (getaddrinfo / .local mDNS resolution), send, and
# recvfrom_nonblock.
#
