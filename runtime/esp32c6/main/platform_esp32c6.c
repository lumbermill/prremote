...
{
  /* USB Serial/JTAG driver is installed by ESP-IDF startup code
   * (CONFIG_ESP_CONSOLE_USB_SERIAL_JTAG=y).  Disable stdio buffering so
   * the READY protocol is byte-accurate. */
